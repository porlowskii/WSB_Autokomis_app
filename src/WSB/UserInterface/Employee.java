            ...
            if (pass.equals(login + controlNumber)) {
                ...
                if (target == 1) {
                    ...
                    if (targetSalon == 1) {
                        ...
                        String uslugi = scan.nextLine();
                        String[] uslugaNo = uslugi.trim().split(",");
                        if (uslugaNo.equals("3") && uslugaNo.equals("1") || uslugaNo.equals("3") && uslugaNo.equals("2")) {
                            System.out.println("Tak się nie da!");
                            break;
                        }
                        if (uslugaNo.equals("1")) {
                            System.out.println("usluga1");
                        }
                        if (uslugaNo.equals("2")) {
                            System.out.println("usluga2");
                        }
                        System.out.println("Aby potwierdzic sprzedaż pojazdu wpisz [sell]");
                        String confirm = scan.nextLine();
                        if (confirm.toLowerCase(Locale.ROOT).trim().equals("sell")) {
                            dbf.removeVehicle(1, 1, carNumber);
